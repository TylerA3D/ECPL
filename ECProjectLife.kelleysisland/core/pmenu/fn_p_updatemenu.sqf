...
_mstatus ctrlSetStructuredText parseText format["<img size='1.3' image='\ecpl_misc\icons\bank.paa'/> <t size='0.8px'>$%1</t><br/><img size='1.2' image='\ecpl_misc\icons\money.paa'/> <t size='0.8'>$%2</t>",[life_atmcash] call life_fnc_numberText,[life_cash] call life_fnc_numberText];

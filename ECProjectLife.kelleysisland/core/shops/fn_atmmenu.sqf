...
lbClear _units;
_text ctrlSetStructuredText parseText format["<img size='1.7' image='\ecpl_misc\icons\bank.paa'/> $%1<br/><img size='1.6' image='\ecpl_misc\icons\money.paa'/> $%2",[life_atmcash] call life_fnc_numberText,[life_cash] call life_fnc_numberText];
